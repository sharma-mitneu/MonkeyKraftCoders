...
const SidePanelItem = ({
    ...
    return (
        <Link
            to={to}
            className=" block w-[88%] mx-auto my-[8px] rounded-md hover:bg-borders py-[6px] px-[10px] text-[14px] text-white hover:text-white"
            style={style}
        >
            <div>{text}</div>
        </Link>
        ...
        <>
            ...
            >
                <div className="relative h-[100px]  ">
                    ...
                    <button
                        onClick={() => displayFn(false)}
                        className=" relative w-[30px] h-[30px] text-borders hover:text-red hover:bg-borders rounded-md left-[274px] top-[13px] "
                    >
                ...
                <hr className="border-borders w-[88%] mx-auto" />
                <div
                    className=" block w-[88%] mx-auto my-[8px] rounded-md hover:bg-borders py-[6px] px-[10px] text-[14px] text-white hover:text-white hover:bg-red-600 cursor-pointer "
