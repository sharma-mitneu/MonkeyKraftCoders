        ...
        <>
            <div className="fixed w-full h-[60px] bg-white border-b border-borders flex felx-row z-[100]">
                <Link to="/" className=" select-none">
                    <div
                        id="logo-cont"
                        className="inline-block text-[24px] font-bold bold mx-[36px] mt-[12px]"
                    >
                        <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-700 to-black px-[1px]">
                            MonkeyKraft Coders
                        </span>
                        {/* <span className="font-normal">Coders</span> */}
                    </div>
                </Link>
                {data != undefined &&
                    "items" in data &&
                    ...
                    data.items.map((elem) => (
                        <Link
                            to={elem.link_path}
                            className="mt-[15px] hidden md:inline-block text-[14px] h-fit p-[5px] text-[#808080] hover:text-black transition"
                        >
                ...
                {data?.status === "loggedin" || data?.status == undefined ? (
                    ...
                    <div className="fixed flex flex-row right-[36px] items-center h-[60px]">
                        <Link
                            to="/login"
                            className="inline-block font-bold py-[6px] px-[16px] bg-white hover:bg-borders border rounded-md border-borders text-black text-[14px] hover:bg-orange-600"
                        >
                            Log In
                        </Link>
                        <Link
                            to="/signup"
                            className="ml-[8px] font-bold inline-block py-[6px] px-[16px] bg-gradient-to-r from-black-500 to-red-600 border rounded-md border-borders text-black text-[14px] hover:bg-orange-600"
                        >
                            Sign Up
                        </Link>
                    </div>
