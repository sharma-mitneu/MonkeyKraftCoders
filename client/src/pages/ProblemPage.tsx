...
const ProblemPage = ({
    ...
    useEffect(() => {
        axios
            .post(`${API_URL}/api/problem/read/${name}`, { id: id })
            .then(({ data }) => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${API_URL}/api/problem/read/${name}/${activeNavOption}`)
            .then(({ data }) => {
                    ...
                    <div className="flex flex-col h-[calc(100%-16px)] min-w-[calc(20%-8px)] mr-[8px] flex-grow">
                        <div className="min-h-0 flex-grow min-w-full mr-[8px] mb-[8px] rounded-lg overflow-hidden bg-black border border-borders">
                            <div className="h-[50px] bg-black relative border-b border-borders">
                                ...
                                <select
                                    className="absolute top-[8px] right-[13px] bg-black text-text_2 border-b border-borders cursor-pointer text-[14px] hover:text-white"
