...
const ProfilePage = ({
    ...
    return (
        <div>
            ...
            {user != null ? (
                <>
                    <div className="w-[calc(100%-72px)] h-[260px] sm:h-[160px] bg-white mx-auto mt-[8px] rounded-lg border border-borders">
                        <div
                            id="main"
                        ...
                        >
                            ...
                            <div className="flex flex-col w-[280px] text-center sm:text-left mx-auto sm:ml-0">
                                <div
                                    id="username"
                                    className="text-[28px] font-bold mt-[20px] sm:mt-[40px] text-black sm:ml-[30px] ml-0"
                                >
                                    {user.username}
                                </div>
                                <div
                    ...
                    <div className="flex lg:flex-row sm:flex-col flex-col w-[calc(100%-72px)] mx-auto justify-between">
                        <div className="lg:w-[calc(40%-4px)] sm:w-full h-[240px] bg-white mt-[8px] rounded-lg border border-borders">
                            <div className="text-[22px] font-bold mt-[40px] text-black ml-[50px]">
                                Community Stats
                            </div>
                        ...
                        <div className="lg:w-[calc(60%-4px)] sm:w-full sm:h-[240px] h-[450px] bg-white mt-[8px] rounded-lg border border-borders relative">
                            <div className="flex sm:flex-row flex-col justify-between">
                                <div>
                                    <div className="text-[22px] font-bold mt-[40px] text-black ml-[50px]">
                                        Solved Problems
                                    </div>
                                    <div className="text-[72px] font-bold mt-[32px] text-black ml-[50px]">
